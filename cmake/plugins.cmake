  ...
  if(NOT ${CC_PLUGIN_DEFAULT} STREQUAL "OFF")
    ...
    if(${CC_PLUGIN_DEFAULT} MATCHES "DYNAMIC")
      ...
      if(CMAKE_SYSTEM_NAME MATCHES "Linux")
        #target_compile_options(${CC_PLUGIN_TARGET} PRIVATE "-fvisibility=hidden")
        target_link_options(${CC_PLUGIN_TARGET} PRIVATE "-Wl,--no-undefined" PRIVATE "-Wl,--dynamic-list=${CC_SOURCE_DIR}/plugins/dynamic_plugin_exports.txt")
      elseif(WIN32)
