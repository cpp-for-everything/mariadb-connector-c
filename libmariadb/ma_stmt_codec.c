...
void mysql_init_ps_subsystem(void)
{
  ...
  mysql_ps_fetch_functions[MYSQL_TYPE_TIME].pack_len  = sizeof(MYSQL_TIME);
  mysql_ps_fetch_functions[MYSQL_TYPE_TIME].max_len  = 17;

  mysql_ps_fetch_functions[MYSQL_TYPE_DATE].func  = ps_fetch_datetime;
  mysql_ps_fetch_functions[MYSQL_TYPE_DATE].pack_len  = sizeof(MYSQL_TIME);
  ...
  mysql_ps_fetch_functions[MYSQL_TYPE_DATETIME].pack_len= sizeof(MYSQL_TIME);
  ...
  mysql_ps_fetch_functions[MYSQL_TYPE_TIMESTAMP].pack_len= sizeof(MYSQL_TIME);
